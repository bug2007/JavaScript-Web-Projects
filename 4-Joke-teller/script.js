...
// passing joke from getJokes() to VoiceRSS API
function tellMe(joke) {
    VoiceRSS.speech({
        key: '3b84a93ea6b64449bacc9d80777a79e1',
        src: joke,
        hl: 'en-us',
        r: 0,
        c: 'mp3',
...
audioElement.addEventListener('ended', toggleButton);   //check if current playlist has ended